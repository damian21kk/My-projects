...
%new_table creates a table of events in case no data was saved in the directory
%   This function returns a table with a new event, the table can then be modified by the user.
